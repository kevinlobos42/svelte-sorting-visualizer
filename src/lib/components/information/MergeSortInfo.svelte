...
>
  ...
  <div class="h-full w-full px-8">
    <button
      ...
      >
      <p class="text-3xl">Merge Sort Explanation</p>
      ...
      <p class="text-2xl">Advantages of Merge Sort:</p>
      <ul class="font-normal list-disc">
        <li>
          <b>Stability</b> : Merge sort is a stable sorting algorithm, which means
          it maintains the relative order of equal elements in the input array.
        </li>
        <li>
          <b>Guaranteed worst-case performance</b>: Merge sort has a worst-case
          time complexity of O(N logN) , which means it performs well even on
          large datasets.
        </li>
        <li>
          <b>Simple to implement</b>: The divide-and-conquer approach is
          straightforward.
        </li>
        <li>
          <b>Naturally Parallel</b> : We independently merge subarrays that makes
          it suitable for parallel processing.
        </li>
      </ul>
      <hr class="my-5" />

      <p class="text-2xl">Disadvantages of Merge Sort:</p>
      <ul class="font-normal list-disc">
        <li>
          <b>Space complexity</b>: Merge sort requires additional memory to
          store the merged sub-arrays during the sorting process.
        </li>
        <li>
          <b>Not in-place</b>: Merge sort is not an in-place sorting algorithm,
        ...
        <li>
          <b>Slower than QuickSort in general</b>. QuickSort is more cache

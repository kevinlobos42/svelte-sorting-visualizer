...
<div
  class="{open
    ? 'visible'
    : 'invisible'} w-full h-[100vh] bg-black bg-opacity-50 fixed top-0 z-50 grid place-items-center"
>
  <div
    class="relative py-6 px-12 border-white bg-black border-2 rounded-md flex flex-col items-center justify-center  max-w-[80%]"
  >
    <div class="h-full w-full">
      ...
      <p class="font-normal pb-2">
        ...
        that picks an element as a pivot and partitions the given array around the
         ...
         array. <b>The Pivot selection is the most important part of this algorithm.</b>
      </p>
      <img
      ...
      <ul class="font-normal">
        ...
        divides the array into roughly equal halves. In this case, the algorithm will make
        ...
        is always chosen as the smallest or largest element. To mitigate the worst-case Scenario,
      ...
      <ul class="font-normal list-disc">
        ...
        <li>It is Cache Friendly as we work on the same array to sort and do not
      ...
      <ul class="font-normal list-disc">
        <li> It has a worst-case time complexity of O(N 2 ), which occurs when the pivot is
           chosen poorly.
        </li>
        <li> It is not a good choice for small data sets.</li>
        <li>It is not a stable sort, meaning that if two elements have the same key, their relative
